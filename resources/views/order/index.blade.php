...
@section('content')
    <div class="container mt-5">
        ...
        <a href="{{ route('order.create') }}" class="btn btn-primary mb-3"><svg xmlns="http://www.w3.org/2000/svg"
            ...
            <tbody>
                @foreach ($orders as $order)
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('order.show', $order->id) }}" class="btn btn-info"><svg
                            ...
                            <a href="{{ route('order.edit', $order->id) }}" class="btn btn-warning"><svg
                                    xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
